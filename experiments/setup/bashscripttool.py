...
with open("src/run_experiments.sh", "w") as f:
    for i in range(len(models)):
        ...
        f.write('mv src/outputs/ml-1m/*.json outputs/ml-1m/Experiment_' + str(i+1) +'_' + models[i] +'/Gender\n')
        ...
        f.write('mv src/outputs/ml-1m/*.json outputs/ml-1m/Experiment_' + str(i+1) +'_' + models[i] +'/Age\n\n')

with open("src/run_experiments_lt.sh", "w") as f:
    for i in range(len(models)):
        ...
        f.write('mv src/outputs/lt/*.json outputs/Experiment_' + str(i+1) +'_' + models[i] +'\n')


with open("src/plot_experiments.sh", 'w') as f:
    for i in range(len(models)):
