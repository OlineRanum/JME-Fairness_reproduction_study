...
mv src/outputs/lt/*.json src/outputs/Experiment_1_BPRMF
...
mv src/outputs/lt/*.json src/outputs/Experiment_2_LDA
...
mv src/outputs/lt/*.json src/outputs/Experiment_3_PureSVD
...
mv src/outputs/lt/*.json src/outputs/Experiment_4_SLIM
...
mv src/outputs/lt/*.json src/outputs/Experiment_5_WRMF
...
mv src/outputs/lt/*.json src/outputs/Experiment_6_CHI2
...
mv src/outputs/lt/*.json src/outputs/Experiment_7_HT
...
mv src/outputs/lt/*.json src/outputs/Experiment_8_KLD
...
mv src/outputs/lt/*.json src/outputs/Experiment_9_LMWI
...
mv src/outputs/lt/*.json src/outputs/Experiment_10_LMWU
...
mv src/outputs/lt/*.json src/outputs/Experiment_11_SVD
...
mv src/outputs/lt/*.json src/outputs/Experiment_12_NNI
...
mv src/outputs/lt/*.json src/outputs/Experiment_13_NNU
...
mv src/outputs/lt/*.json src/outputs/Experiment_14_PLSA
...
mv src/outputs/lt/*.json src/outputs/Experiment_15_POP
...
mv src/outputs/lt/*.json src/outputs/Experiment_16_Random
...
mv src/outputs/lt/*.json src/outputs/Experiment_17_RM1
...
mv src/outputs/lt/*.json src/outputs/Experiment_18_RM2
...
mv src/outputs/lt/*.json src/outputs/Experiment_19_RSV
...
mv src/outputs/lt/*.json src/outputs/Experiment_20_RW
...
mv src/outputs/lt/*.json src/outputs/Experiment_21_UIR
